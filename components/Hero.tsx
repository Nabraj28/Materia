    ...
    <section className="relative w-full h-dvh min-h-145 flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 w-full h-full">
        <Image
          ...
          alt="Architectural sustainable building facade"
          fill
          priority
          sizes="100vw"
          className="object-cover object-[center_30%]"
        />
        {/* Gradient Overlay — lighter at top, softer at bottom */}
      ...
      <div className="relative z-10 w-full max-w-4xl px-4 sm:px-6 md:px-8 mx-auto -mt-8 flex flex-col justify-center">
        {/* Headline Panel */}
        <div className="glass-panel p-6 sm:p-8 border-l-4 border-[#9c4000] mb-4 sm:mb-6 shadow-md rounded">
